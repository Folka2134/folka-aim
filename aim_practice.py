...
class Target:
    ...
    def draw_circle(self, window):
        pygame.draw.circle(window, self.COLOUR, (self.x, self.y), self.size)
        pygame.draw.circle(
            window, self.SECOND_COLOUR, (self.x, self.y), self.size * 0.8
        )
        pygame.draw.circle(window, self.COLOUR, (self.x, self.y), self.size * 0.6)
        pygame.draw.circle(
            window, self.SECOND_COLOUR, (self.x, self.y), self.size * 0.4
        )
